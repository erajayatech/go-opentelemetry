...
func (c *exampleClient) Foo(ctx context.Context, in *ReqFoo, opts ...grpc.CallOption) (*ResFoo, error) {
	out := new(ResFoo)
	err := c.cc.Invoke(ctx, Example_Foo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	Foo(context.Context, *ReqFoo) (*ResFoo, error)
...
func (UnimplementedExampleServer) Foo(context.Context, *ReqFoo) (*ResFoo, error) {
...
func _Example_Foo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqFoo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).Foo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Example_Foo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Foo(ctx, req.(*ReqFoo))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pbfoo.Example",
	HandlerType: (*ExampleServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Foo",
			Handler:    _Example_Foo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pbfoo.proto",
}
